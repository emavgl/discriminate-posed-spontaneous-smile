%
% Demo A2: Iteratively-Reweighted NRSFM with Rotation Invariant Kernels (cross-validation experiment)
% 
% -----------------------------------------------------------------------------
clear all
...
K = 27;                          % number of basis shapes (iterations of IRLS)
ds1 = { 0.1, 0.3, 0.2, 0.05 };   % number of vectors (%T) in KPCA basis (2D RIK)
